...
- (instancetype)initWithImageNames:(NSArray *)imageNames
{
    ...
    if (self) {
        ...
        for (UIView *view in @[self.whiteView, self.purpleView, self.leftButton,
                               self.cameraButton, self.rightButton]) {
...
- (void)createConstraints
{
    ...
    NSDictionaryOfVariableBindings(_leftButton, _cameraButton, _rightButton, _whiteView, _purpleView);
    ...
    // The left and right buttons have 10 points spacing from the top. All three buttons are aligned
    ...
    NSArray *allConstraintArrays = @[allButtonsHorizontalConstraints, leftButtonVerticalConstraints,
                                     cameraButtonVerticalContraints, rightButtonVerticalConstraints,
                                     whiteViewHorizontalConstraints, whiteViewVerticalConstraints,
                                     purpleViewHorizontalConstraints, purpleViewVerticalConstraints];
