...
- (void)viewDidLoad {
   ...
   // [self clearInstagramCookies];
    ...
    NSString *urlString = [NSString stringWithFormat:@"https://instagram.com/oauth/authorize/?client_id=%@&scope=basic+likes+comments+relationships&redirect_uri=%@&response_type=token", [DataSource instagramClientID], [self redirectURI]];
    
  //  NSString *urlString = [NSString stringWithFormat:@"https://api.instagram.com/oauth/authorize/?client_id=%@&redirect_uri=%@&response_type=code&scope=likes+comments+relationships", [DataSource instagramClientID], [self redirectURI]];
  
//    NSString *urlString = [NSString stringWithFormat:@"https://instagram.com/oauth/authorize/?client_id=%@&redirect_uri=%@&response_type=token&scope=basic+likes+comments", [DataSource instagramClientID], [self redirectURI]];
