...
// This view contains a text view and a button
// needs to conform to the UITextViewDelegate protocol
...
- (void)layoutSubviews
{
    ...
    if (self.isWritingComment) {
        ...
        self.button.backgroundColor = [UIColor colorWithRed:0.345 green:0.318 blue:0.424 alpha:1]; /*#58165*/
